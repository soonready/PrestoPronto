...
AppVersion= b 1.0.0
;AppVerName=PrestoPronto  b 1.0
AppPublisherURL=https://github.com/soonready/PrestoPronto
AppSupportURL=https://github.com/soonready/PrestoPronto
AppUpdatesURL=http://soonready.github.io/PrestoPronto/
;DefaultDirName={pf}\PrestoPronto
DefaultGroupName=PrestoPronto
InfoAfterFile=README.txt
OutputBaseFilename=PrestoPronto_b1.0_setup
Compression=lzma
